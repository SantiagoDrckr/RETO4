...
// metodo que trae a todos los empleados exitentes de la base de datos
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jTabbedPane8, javax.swing.GroupLayout.DEFAULT_SIZE, 1086, Short.MAX_VALUE)
        );
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        System.out.println(" departamento: " + departamentoOptionT + ", zona: "
                + zonaOptionT + ", Calle: " + tipoCalleT + ", numero: " + numero1 + "-" + numero2 + "-" + numero3);

        String queryDireccion = "INSERT INTO `direccion`(`zona`, `tipoCalle`, `numero1`, `numero2`, `numero3`, `nombreDepartamento`) VALUES ('" + zonaOptionT + "','" + tipoCalleT + "','" + numero1 + "','" + numero2 + "','" + numero3 + "', '" + departamentoOptionT + "')";
